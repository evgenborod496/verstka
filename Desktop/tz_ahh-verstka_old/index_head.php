...
<![endif]-->
    ...
    <body>
		<div class="container">
			<div class="header_flex header">
                <div class="logo h_flex_logo">            
                    <img src="logo_archholder_black.svg" alt="logo" />
                    <div class="text_only_logo text_only_logo__mod">сервис для архитекторов и визуализаторов</div>
                </div>
                <ul class="h_menu_flex">
                   <li>
                        <h2>
                            <a href="#">ГАЛЕРЕЯ</a>
                        </h2>
        ...
        <div id="pano" class="pano_height">
            <div class="text_only_main_page text_only_main_page__mod">
            ...
            <iframe  scrolling="no" style="position:relative;height:675px;min-width:900px;" src="primer/iframe.html" width="100%" height="100%" frameborder="0"></iframe>
        </div>
        <div id="container"></div>
        <main>
            <div class="buttons buttons__mod">
                ...
                <form enctype="multipart/form-data" method="post" action="iu/uploader.php" id="upload-form">
                    <div class="text_button_upload" id="upload1">ЗАГРУЗИТЬ</div>
            ...
            <ul class="buttons_tabs">
                ...
                <li>
                    <h1>
                        <a href="#SketchUp">Как сделать такую же панораму с помощью SketchUp?</a>
                    </h1>
                </li>
                <li>
                    <h1>
                        <a href="#Сinema4D">Как сделать панораму с помощью Сinema4D?</a>
                    </h1>
                </li>
                <li>
                    <h1>
                        <a href="#Maya">Как сделать панораму с помощью Maya?</a>
                    </h1>
                </li>
            </ul>
            <div class="manual_container">
                <div class="tabs_with_help" id="3dsMax">
                   <ul class="tabs_with_help_buttons clearfix">
                       <li class='active'><a href="#manual_1"><h3>С помощью Vray:</h3></a></li>
                       <li><a href="#manual_2"><h3>С помощью <span>Iray, MentalRay, Corona и др:</span></h3></a></li>
                   </ul>
                  <div class="manual_content">
                      <div class="manual_content_item" id="manual_1">
                          ...
                          <div class="manual_item_first">
                              ...
                              <div class="manual_item_first_photo">
                                  ...
                                  <div class="text_italic">
                                      <p><span class="indent_paragraph"></span>Камера имеет встроенную регулировку угла обзора, но она не является сферической и максимальный угол обзора, который возможно там установить, не превышает 175 градусов. Для обхода этого ограничения V-Ray имеет специальный инструмент, расширяющий возможности стандартной камеры. Все изменения, сделанные с помощью этого инструмента не отображаются во вьюпорте 3ds Max и будут видны непосредственно на визуализации.</p>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="manual_item">
                              ...
                              <div class="manual_text_position_left_short">
                                  <p>
                                      <span class="indent_paragraph"></span>Для просмотра в виде виртуального тура, можете присылать картинку на сервер. Разрешение присылаемых jpg-файлов, не должно быть более 8000х4000px и неболее 20мб.
                                  </p>
                                  <br><br>
                              ...
                              <img class="broad_picture" src="tz_example1.jpg" alt="screen" />
                              <div class="clear"></div><br><br>
                          </div>
                          <a href="/archholder_3dsmax-vray.rar" class="text_link_download">Скачать пример  виртуального 3D тура</a>
                      </div>
                      <div class="manual_content_item" id="manual_2">
                          ...
                          <div class="manual_item">
                              ...
                              <img class="manual_broad_picture" src="tz_example1.jpg" alt="screen" />
                              <div class="clear"></div><br><br>
                          </div>
               ...
               <div class="tabs_with_help" id="SketchUp">
                   <ul class="tabs_with_help_buttons clearfix">
                       <li class='active'><a href="#manual_3"><h3>С помощью Vray:</h3></a></li>
                       <li><a href="#manual_4"><h3>С помощью <span>Iray, MentalRay, Corona и др:</span></h3></a></li>
                   </ul>
                  <div class="manual_content">
               ...
               <div class="tabs_with_help" id="Сinema4D">
                   <ul class="tabs_with_help_buttons clearfix">
                       <li class='active'><a href="#manual_5"><h3>С помощью Vray:</h3></a></li>
               ...
               <div class="tabs_with_help" id="Maya">
                   <ul class="tabs_with_help_buttons clearfix">
                       <li class='active'><a href="#manual_7"><h3>С помощью Vray:</h3></a></li>
                       <li><a href="#manual_8"><h3>С помощью <span>Iray, MentalRay, Corona и др:</span></h3></a></li>
                   </ul>
                  <div class="manual_content">
                      <div class="manual_content_item" id="manual_7">
                          <a href="/archholder_3dsmax-vray.rar" class="text_link_download">Скачать пример  виртуального 3D тура</a>
                          <div class="manual_item_first">
                              <span class="text_number_manual">1</span>
                              <div class="text_manual_item_first">
                      ...
                      <div class="manual_content_item" id="manual_8">
                          <div style="text-align: center;" class="manual_item_first">
                              <span class="text_number_manual">1</span>
                              <div style="text-align: left;" class="text_manual_item_first">
                                  <p><span class="indent_paragraph"></span>Создайте камеру и разместите ее так, что бы высота камеры и точка в которую вы смотрите, находились на одной высоте (на уровне человеческого глаза). В зависимости от рендера можно поэксперементировать с любой камерой я пробовал лишь с обычной. Далее заходим в:</p>
